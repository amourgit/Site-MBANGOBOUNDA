...
export function AnimationSettingsPanel() {
  ...
  const easingOptions: { value: string; label: string }[] = [
  ...
  const presetOptions: { value: string; label: string; icon: React.ReactNode }[] = [
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => updateSettings({ easing: value as string })}
                    >
