      ...
      >
        ...
        >
          ...
          <CardContent className="p-4 md:p-6 relative z-10">
            <p className="text-sm md:text-base mb-4 leading-relaxed transition-colors duration-300 text-white-800 dark:text-white">
              "{testimonial.review}"
            </p>
...
const KineticTestimonial: React.FC<KineticTestimonialProps> = ({
  ...
  return (
    <section
      className={`bg-black-50 dark:bg-black transition-colors duration-300`}
    >
      <div className="relative w-full text-gray-900 dark:text-white py-8 md:py-20 flex flex-col items-center overflow-hidden px-4 md:px-6 bg-black">
        ...
        {testimonials && testimonials.length > 0 && (
          <>
            <div className="hidden xl:flex gap-4 w-full max-w-7xl overflow-hidden relative mx-4 bg-black">
              <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-black dark:from-black to-transparent z-10 pointer-events-none"></div>
              <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black dark:from-black to-transparent z-10 pointer-events-none"></div>
            ...
            <div className="sm:hidden flex gap-3 w-full overflow-hidden relative px-4 bg-black">
              <div className="absolute top-0 left-0 right-0 h-20 bg-gradient-to-b from-black dark:from-black to-transparent z-10 pointer-events-none"></div>
              <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-black dark:from-black to-transparent z-10 pointer-events-none"></div>
