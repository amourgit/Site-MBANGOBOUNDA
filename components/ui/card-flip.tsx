        ...
        <div className="w-full" style={{ backfaceVisibility: "hidden" }}>
          <div className="relative w-full">
            <button
              ...
              className="absolute top-1 right-1 rounded-full hover:bg-muted transition-colors z-10"
        ...
        >
          <div className="relative w-full h-full">
            <button
              ...
              className="absolute top-1 right-1 rounded-full hover:bg-muted transition-colors z-20"
              aria-label="Close"
            >
...
function CardFlipFront({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-transparent text-card-foreground flex flex-col",
        className
      )}
      {...props}
    />
