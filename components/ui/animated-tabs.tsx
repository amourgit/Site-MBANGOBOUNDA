    ...
    >
      <span
        className={twMerge(
          ...
          isActive
            ...
            : "text-white/30 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100"
        )}
      >
        {children}
      </span>
      <span
        className={twMerge(
          ...
          isActive ? "scale-y-100 bg-black/30 dark:bg-white" : "bg-transparent"
        )}
      />
    </button>
  );
...
const TabsContent = ({
  ...
  return activeTab === value ? <div className="p-2">{children}</div> : null;
};
