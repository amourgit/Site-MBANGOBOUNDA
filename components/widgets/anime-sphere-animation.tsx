...
const AnimeSphereAnimation = () => {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center p-2 md:p-8">
      <div className="relative w-full max-w-[500px] pb-[100%] md:max-w-[580px] md:pb-[50%]">
        <div ref={sphereRef} className="absolute left-1/2 top-1/2 -ml-[250px] -mt-[250px] h-[500px] w-[500px] md:-ml-[290px] md:-mt-[290px] md:h-[580px] md:w-[580px]">
          <svg className="sphere h-full w-full" viewBox="0 0 440 440" stroke="rgba(80,80,80,.35)">
            <defs>
            ...
            <path d="M343.043 342.677c-59.8 59.799-125.292 91.26-146.283 70.268-20.99-20.99 10.47-86.483 70.269-146.282 59.799-59.8 125.292-91.26 146.283-70.269 20.99 20.991-10.47 86.484-70.27 146.283z" />
