...
import SpotifyNotificationBar from "@/components/ui/notification-top";
...
export const CompactTopBar = ({ className = '' }: { className?: string }) => {
  ...
  return (
    <div className={`fixed flex flex-col top-0 px-[40px] left-0 right-0 h-12 bg-transparent z-50 ${className}`}>
      ...
      <div className="h-10 bg-transparent backdrop-blur-sm flex items-center justify-between px-3 theme-transition">
